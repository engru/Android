...
public class WifiDirectFunctions implements PeerListListener ,ConnectionInfoListener{
	private IWifiDirectActionListener mActionListener;
	public List<WifiP2pDevice> peers = new ArrayList<WifiP2pDevice>();
	
	public WifiDirectFunctions(IWifiDirectActionListener mActionListener){
