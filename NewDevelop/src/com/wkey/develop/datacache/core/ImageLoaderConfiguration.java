 ...
 *******************************************************************************/
package com.wkey.develop.datacache.core;
...
import com.wkey.develop.datacache.cache.disc.DiscCacheAware;
import com.wkey.develop.datacache.cache.disc.impl.UnlimitedDiscCache;
import com.wkey.develop.datacache.cache.disc.naming.FileNameGenerator;
import com.wkey.develop.datacache.cache.memory.MemoryCacheAware;
import com.wkey.develop.datacache.cache.memory.impl.FuzzyKeyMemoryCache;
import com.wkey.develop.datacache.core.assist.MemoryCacheUtil;
import com.wkey.develop.datacache.core.assist.QueueProcessingType;
import com.wkey.develop.datacache.core.decode.ImageDecoder;
import com.wkey.develop.datacache.core.download.ImageDownloader;
import com.wkey.develop.datacache.core.download.NetworkDeniedImageDownloader;
import com.wkey.develop.datacache.core.download.SlowNetworkImageDownloader;
import com.wkey.develop.datacache.utils.L;
...
public final class ImageLoaderConfiguration {
	...
	public static class Builder {
		 ...
		 * {@link com.wkey.develop.datacache.cache.memory.impl.LruMemoryCache LruMemoryCache} will be used as
		 ...
		 * Default value - {@link com.wkey.develop.datacache.cache.memory.impl.LruMemoryCache LruMemoryCache}
		 ...
		 * <b>NOTE:</b> If you use this method then
		 * {@link com.wkey.develop.datacache.cache.disc.impl.TotalSizeLimitedDiscCache TotalSizeLimitedDiscCache}
		 ...
		 * By default: disc cache is unlimited.<br />
		 * <b>NOTE:</b> If you use this method then
		 * {@link com.wkey.develop.datacache.cache.disc.impl.FileCountLimitedDiscCache FileCountLimitedDiscCache}
		 * will be used as disc cache. You can use {@link #discCache(DiscCacheAware)} method for introduction your own
		 * implementation of {@link DiscCacheAware}
		 */
		 ...
		 * Default value -
		 * {@link com.wkey.develop.datacache.core.DefaultConfigurationFactory#createFileNameGenerator()
		 ...
		 * Default value -
		 * {@link com.wkey.develop.datacache.core.DefaultConfigurationFactory#createImageDownloader(Context)
		 ...
		 * Default value -
		 * {@link com.wkey.develop.datacache.core.DefaultConfigurationFactory#createImageDecoder(boolean)
		 ...
		 * Default value - {@link com.wkey.develop.datacache.cache.disc.impl.UnlimitedDiscCache
		 * UnlimitedDiscCache}. Cache directory is defined by
		 * {@link com.wkey.develop.datacache.utils.StorageUtils#getCacheDirectory(Context)
