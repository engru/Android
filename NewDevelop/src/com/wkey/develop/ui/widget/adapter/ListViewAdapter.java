package com.wkey.develop.ui.widget.adapter;
...
public class ListViewAdapter extends BaseAdapter {   
    ...
    public void addListItem(List<Map<String, Object>> listItems){
    ...
    public View getView(int position, View convertView, ViewGroup parent) {   
        ...
        if (convertView == null) {   
            ...
            //获取list_item布局文件的视图   
            convertView = listContainer.inflate(R.layout.list_item_product, null);   
            //获取控件对象   
